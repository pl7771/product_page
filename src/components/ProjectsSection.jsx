    ...
    <section id="projects-section" className="relative py-16 sm:py-24 overflow-hidden bg-slate-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="text-center mb-10">
          <h2 className="text-3xl sm:text-4xl font-black text-slate-900 tracking-tight mb-3">{t('projectsSection.title')}</h2>
          <p className="text-base text-slate-600 max-w-2xl mx-auto">{t('projectsSection.subtitle')}</p>
        </div>
