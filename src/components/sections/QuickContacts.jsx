    ...
    <section id="contact" className="w-full px-4 sm:px-6 lg:px-8 py-20 bg-white">
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`grid grid-cols-1 gap-8 mb-20 ${lang === 'en' ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
          <div className="group bg-white border border-slate-200 rounded-2xl p-6 flex flex-col items-center text-center hover:border-[#07C160] hover:shadow-xl hover:shadow-[#07C160]/10 transition-all duration-300 relative overflow-hidden">
