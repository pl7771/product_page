...
export default {
  ...
  hero: {
    ...
    titleHighlight: '微雾',
    titleLine2: '系统',
    subtitleLine1: '专注于局部空间环境改善，提供加湿、除尘、降温一站式解决方案',
    subtitleLine2: '集研发、销售与微雾工程项目设计施工于一体',
    ctaPrimary: '查看设备',
    ctaSecondary: '联系我们',
  ...
  products: {
    ...
    title: '产品图库',
    titleHighlight: '',
    descriptionLine1: '我们为客户安装项目部署的雾森系统、造雾与高压微雾设备组件',
    descriptionLine2: '源头厂家直供，提供喷雾加湿、降温、除尘及安装维修服务',
    requestOffer: '获取报价',
    contact: '联系',
    photosSoon: '图片即将上线',
    specsTitle: '超声波加湿机',
  ...
  trust: {
    ...
    title: '',
    description:
      '本公司深耕环保雾化设备领域，集研发、销售与微雾工程于一体。我们以"局部空间环境改善"为核心导向，致力于为各行业客户提供加湿、除尘、降温等一站式定制化解决方案，精准赋能四大核心业务板块。',
    hpBlock: '',
    features: [
      '工业车间环境调控：针对造纸、印刷、化工、纺织化纤、电子制造等工业制造场景，提供高效的车间降温与抑尘服务，助力企业改善生产环境，提升产品良率与生产效率。',
      '市政环卫与畜牧防疫：针对垃圾场、垃圾中转站等易产生异味的场所，提供科学的除臭解决方案；同时，为畜牧养殖业提供安全、高效的防疫消毒雾化系统，保障公共卫生安全。',
      '现代农业精准加湿：深入农业现代化发展需求，为农业大棚、食用菌培育及食品加工等行业提供精准的加湿方案，为农作物与微生物的生长创造最适宜的微气候环境。',
      '文旅景观生态造雾：结合生态美学与雾化技术，为地产项目、旅游景区等提供极具观赏价值的人造雾景观设计与施工服务，打造如梦似幻的生态视觉体验。',
    ],
